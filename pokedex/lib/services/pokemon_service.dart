      ...
      if (response.statusCode == 200) {
        ...
        for (var result in results) {
          ...
          if (pokemonResponse.statusCode == 200) {
            ...
            throw Exception(
                'Falha ao carregar lista de pokemons. Status Code: ${pokemonResponse
                    .statusCode}');
          }
        }
        print(listPokemons.length);
        return listPokemons;
      } else {
        throw Exception(
            'Falha ao carregar lista de dados dos pokemons. Status Code: ${response
                .statusCode}');
      }
    } catch (e) {
